...
def input_evaluation_set():
	...
	features = {
        'region': numpy.ndarray(shape=(matrix_length,112), dtype=int),
        'type':  numpy.ndarray(shape=(matrix_length,2), dtype=int),
        'device': numpy.ndarray(shape=(matrix_length,3), dtype=int),
        'reaction':  numpy.ndarray(shape=(matrix_length,5), dtype=int),
